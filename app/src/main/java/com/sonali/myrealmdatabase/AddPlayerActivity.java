...
public class AddPlayerActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private int REQUEST_SHOW_PLAYER = 300;
    CircleImageView img;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item.getItemId() == android.R.id.home) {
            Intent i = new Intent(AddPlayerActivity.this, PlayersActivity.class)
                    .putExtra("type", type);
    ...
    private void saveIntoDatabase() {
        try {
            ...
            /*Snackbar.make(btnSave, "Added", Snackbar.LENGTH_LONG)
                    .setAction("Action", null).show();*/
            showMyDialog("Added ", "Add more Player?");
                ...
                .setNegativeButton(android.R.string.no, new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        Intent intent = new Intent(AddPlayerActivity.this, PlayersActivity.class)
                                .putExtra("type", type);
                        ;
                        startActivityForResult(intent, REQUEST_SHOW_PLAYER);
                    }
                })
                .show();
    }
